...
Replacing calculation of sentence vectors from word embeddings to contexualtized word embeddings.
...
def driver(number):
    ...
    for head in headings[0:2]:
        ...
        for rep in reports[0:2]:
            res.append(directory + '/' + head + '/' + rep)

    rep_dir = res[number-1]
    print(rep_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument("number", help="Calculator for AP")

    args = parser.parse_args()

    driver(int(args.number))
